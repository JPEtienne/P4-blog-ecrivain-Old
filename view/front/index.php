        ...
        <?php foreach($posts->getPost() as $post) { ?>
            <div class="media">
                <div class="media-left media-top">
                    <img src="../../images/<?= $post['image'];?>" alt="9gag" class="media-object" style="width:200px;"><br>
                    Ajout: <?=date('d/m/Y', strtotime($post['created_at']));?></p>
                    
                </div>
                <div class="media-body">
                    <h4 class="media-heading"><a href="view/front/view.php?slug=<?=$post['slug']?>"><?=$post['title'];?></a></h4>
